...
- **Numeric constants** (`LOW_BALANCE_THRESHOLD`, `MIN_TOPUP_USDT`, `TOPUP_PRESETS`, `AUTO_GAS_BNB`): update `src/constants.mjs` and `src/funding.mjs` plus their references in `README.md` and `SKILL.md`.
